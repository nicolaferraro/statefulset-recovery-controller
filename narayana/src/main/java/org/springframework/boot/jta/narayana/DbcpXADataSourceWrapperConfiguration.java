...
@ConditionalOnProperty(name = "spring.jta.narayana.dbcp.enabled", matchIfMissing = true)
public class DbcpXADataSourceWrapperConfiguration {

    private final Logger LOG = LoggerFactory.getLogger(DbcpXADataSourceWrapperConfiguration.class);

    @Bean
    public XADataSourceWrapper xaDataSourceWrapper(final NarayanaRecoveryManagerBean recoveryManager, final TransactionManager tm) {
        LOG.info("Overriding default datasource with DBCP datasource");
